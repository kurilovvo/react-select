...
var Select = React.createClass({
	...
	buildMenu: function() {
		...
		if (ops.length) {
			...
			return (
				React.createElement("div", {className: promptClass}, 
					noResultsText
				)
			);
		}
...
var Value = React.createClass({
	...
	render: function() {
		...
		if (this.props.optionLabelClick) {
			...
			label = (
				React.createElement("a", {className: classes('Select-item-label__a', this.props.option.className), 
					onMouseDown: this.blockEvent, 
		...
		return (
			React.createElement("div", {className: classes('Select-item', this.props.option.className), 
				 style: this.props.option.style, 
				 title: this.props.option.title}, 
